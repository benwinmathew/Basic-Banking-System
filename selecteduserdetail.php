...
?>
	...
	<div class="container">
        ...
        <div>
            <table class="table table-hover table-striped table-condensed table-bordered table-light">
        ...
        <select name="to" class="form-control bg-dark text-light" required>
        ...
        <br>
            ...
            <input type="number" class="form-control bg-dark text-light" name="amount" required>   
            <br><br>
